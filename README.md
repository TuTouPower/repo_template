...
8. 删除 `tests/unit/` 与 `tests/integration/` 下模板自带的测试文件——它们验证模板脚本自身；保留 `.gitkeep`。
...
- 操作 skill：`/tasks-preflight`、`/tasks-parallel`、`/task-bug`、`/task-create`、`/pending-to-task`、`/tasks-merge`、`/tasks-run`、`/repo-hygiene`、`/repo-clean`
