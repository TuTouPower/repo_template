...
用法：
  python3 scripts/repo_template/spikes.py new --slug uv_lock_platform_marker
  python3 scripts/repo_template/spikes.py list
...
TEMPLATE_PATH = SPIKES_DIR / "report_template.md"
