...
| `docs/tasks/task_template/`                | task 文件模板（非工作项）                 | 创建 task 时复制                                                                                                                  | 只改模板本身；不得当作 active task 执行                                                    |
...
| `docs/reviews/prompts/`                    | 双审 prompt 模板                          | 渲染 review prompt 时                                                                                                             | 改审查标准时更新；不代表 active review                                                     |
| `docs/reviews/review_<TS>/`                | 独立 review：多模型报告 + adoption 决策   | 审阅全代码 / diff / 指定范围时                                                                                                    | 用户命令后生成                                                                               |
| `docs/spikes/report_template.md`           | spike 报告模板                            | 创建 spike 时复制                                                                                                                 | 只改模板本身                                                                               |
...
| `docs_repo/`                               | 本模板仓库自身的笔记/复盘（非业务文档）   | 调流程、考古本仓设计时                                                                                                            | 不参与 task 状态机；新项目可删可不拷                                                       |
